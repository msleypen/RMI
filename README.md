...
* **Figure 2:** Spatial Spearman correlation

* **Figure 3 & 4:** Simple Daily Intensity Index (SDII) pixelwise map (Raw Values and Relative Bias)

* **Figure 5 & 6:** Simple Daily Intensity Index (SDII) timeseries plot (Raw Values and Relative Bias)
